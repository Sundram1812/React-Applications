...
function App() {
  ...
  function handleAddMovie(newMovie, isExist){
    ...
    setSelectedId(null)  
    // localStorage.setItem('watched',JSON.stringify([...watchedMovie,newMovie]));
  }

    // setting movie in local storage
    useEffect(()=>{
  ...
  return (
    <div className="text-white">
      ...
      <div className="w-10/12 mx-auto flex justify-between  flex-wrap gap-6">
        <MovieBox >
          {isLoading && <Loader/>}
